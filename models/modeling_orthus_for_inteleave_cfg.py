...
class OrthusModel(ChameleonPreTrainedModel):
    """
...
class OrthusForConditionalGeneration(ChameleonPreTrainedModel):
    ...
    def __init__(self, config: ChameleonConfig, diffloss_w=1536, diffloss_d=3, num_res_blocks=3, diffusion_batch_mul=8):
        ...
        self.sample_scheduler = DDIMScheduler(
            beta_schedule          = "scaled_linear",
            beta_start             = 0.00085,
            beta_end               = 0.012,
            num_train_timesteps    = 1000,
    ...
    def forward(
        ...
        if model_inputs_uncon is not None:
            ...
            logits_uncon = self.lm_head(hidden_states_uncon)
        
        if self.model.training and train_mode=='mmg':
        ...
        elif self.model.training and train_mode=='mmu':
        ...
        if model_inputs_uncon is None:
            ...
            return CausalLMOutputWithPast(
                ...
                logits=logits_uncon,
                next_image_latents=next_image_latents,
                past_key_values=outputs_uncon.past_key_values,
                hidden_states=outputs_uncon.hidden_states,
                attentions=outputs_uncon.attentions,
            )
