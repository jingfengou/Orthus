...
# 定义项目和文件的路径
ORTHUS_DIR="../"
BENCHMARK_DIR="../../datasets/mydatasets" # 这里现在指向整个benchmark目录
# 定义临时和最终文件的名称
PREPROCESSED_FILE="orthus_input_for_myb.jsonl"
FINAL_INFERENCE_OUTPUT_FILE="orthus_output_myb_final.jsonl"
CHUNK_DIR="temp_myb_chunks" # 存放数据分片的临时目录
PARTIAL_OUTPUT_DIR="temp_partial_myb_outputs" # 存放送部分结果的临时目录
# MODEL_CHECKPOINT="SJTU-Deng-Lab/Orthus-7B-instruct"
MODEL_CHECKPOINT="/data1/oujingfeng/project/twgi/checkpoints/orthus-7b-sft-think-v01-1"
