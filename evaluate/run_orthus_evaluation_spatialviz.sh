...
FINAL_INFERENCE_OUTPUT_FILE="orthus_output_svb_final.jsonl"
CHUNK_DIR="temp_chunks" # 存放数据分片的临时目录
PARTIAL_OUTPUT_DIR="temp_partial_outputs" # 存放送部分结果的临时目录
# MODEL_CHECKPOINT="SJTU-Deng-Lab/Orthus-7B-instruct"
MODEL_CHECKPOINT="/data1/oujingfeng/project/twgi/checkpoints/orthus-7b-sft-think-v1"
