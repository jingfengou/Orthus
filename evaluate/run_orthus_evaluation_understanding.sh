...
FINAL_INFERENCE_OUTPUT_FILE="orthus_output_svb_understanding_final.jsonl"
CHUNK_DIR="temp_chunks" # 存放数据分片的临时目录
PARTIAL_OUTPUT_DIR="temp_partial_MMU_outputs" # 存放送部分结果的临时目录
# MODEL_CHECKPOINT="SJTU-Deng-Lab/Orthus-7B-instruct"
MODEL_CHECKPOINT="/data1/oujingfeng/project/twgi/checkpoints/orthus-7b-sft-v3"
LOG_DIR="logs_MMU" # <-- 新增：日志目录
...
do
    ...
    CUDA_VISIBLE_DEVICES=$i python ../inference/multimodal_understanding.py \
